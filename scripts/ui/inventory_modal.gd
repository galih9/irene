...
func _create_slot_card(slot_idx: int, item_id: String) -> Control:
	...
	if item_id.is_empty():
		style.bg_color = Color(0.1, 0.12, 0.16, 0.75)
		style.border_color = Color(0.2, 0.25, 0.33, 0.5)
		...
		plus_lbl.add_theme_color_override("font_color", Color(0.3, 0.35, 0.45))
		...
		empty_lbl.add_theme_color_override("font_color", Color(0.35, 0.4, 0.5))
	...
	style.bg_color = Color(0.13, 0.16, 0.23, 0.95)
	...
	btn_style.bg_color = Color(0.25, 0.55, 0.85, 1.0)
